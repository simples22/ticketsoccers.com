      ...
      <div className="tslnFaqHelpInner">
        <div className="tslnFaqHelpContent">
          <div className="tslnFaqHelpIntro">
            <UiTitle>
              How to Buy Tickets on Ticketsoccers
            </UiTitle>
        ...
        <aside
            className="tslnFaqHelpAd"
            aria-label="Ticketsoccers information"
            >
            <div className="tslnFaqHelpCards">

                <article className="tslnFaqHelpCard">
                ...
                <div className="tslnFaqHelpAdBody">
                    ...
                    <h3>Discover live events.</h3>
                    <p>
                    Search sports, concerts, festivals, family events, theatre,
                    comedy, and more.
                    </p>
                </div>
                </article>
                ...
                <div className="tslnFaqHelpAdMedia">
                    <PBImage
                    src="/images/help/select-seats.jpg"
                    alt="Choose tickets"
                    fill
                    className="tslnFaqHelpAdImg"
                    sizes="(max-width:768px) 100vw, 360px"
                ...
                <div className="tslnFaqHelpAdBody">
                    ...
                    <p>
                    Compare ticket options, locations, availability,
                    pricing information, and event details.
                    </p>
                </div>
                </article>
                ...
                <div className="tslnFaqHelpAdMedia">
                    <PBImage
                    src="/images/help/secure-checkout.jpg"
                    alt="Checkout"
                    fill
                    className="tslnFaqHelpAdImg"
                    sizes="(max-width:768px) 100vw, 360px"
                ...
                <div className="tslnFaqHelpAdBody">
                    ...
                    <p>
                    Follow checkout instructions provided by the ticket
                    provider and receive your ticket information.
                    </p>
                </div>
                </article>
